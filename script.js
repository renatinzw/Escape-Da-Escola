  ...
  return `
    <div class="topdown-wrap">
      ...
      <div class="topdown-controls" aria-label="Controles de movimento">
        ...
        <div><button data-move="left" aria-label="Andar para esquerda">◀️</button><button data-move="down" aria-label="Andar para baixo">▼</button><button data-move="right" aria-label="Andar para direita">▶️</button></div>
      </div>
